...
const emit = defineEmits(['update:intensity', 'update:color', 'update:position', 'update:distance', 'update:rotation','update:angle','update:penumbra','update:enabled','handleDel'])
...
const penumbra = computed({
    get() {
        return props.penumbra
    },
    set(value) {
        emit('update:penumbra', value)
    }
})
...
<template>
    <div class="dl">
        ...
        <el-row :gutter="0">
            ...
            <el-col :span="17"> <el-slider v-model="angle" :step="1" :max="90" :min="0" show-input />
            </el-col>
        ...
        <el-row :gutter="0">
            ...
            <el-col :span="17"> <el-slider v-model="penumbra" :step="1" :max="90" :min="0" show-input />
            </el-col>
        ...
        <el-row :gutter="10">
            ...
            <el-col :span="20"> <el-color-picker v-model="color" show-alpha />
            </el-col>
        ...
        <el-row :gutter="10">
            ...
            <el-col :span="20"> <el-slider v-model="rx" :step="1" :max="360" :min="-360" show-input />
            </el-col>
        ...
        <el-row :gutter="10">
            ...
            <el-col :span="20"> <el-slider v-model="ry" :step="1" :max="360" :min="-360" show-input />
            </el-col>
        ...
        <el-row :gutter="10">
            ...
            <el-col :span="20"> <el-slider v-model="rz" :step="1" :max="360" :min="-360" show-input />
            </el-col>
        </el-row>
